...
const REVIEWS = [
  ...
  { initials: 'JM', name: 'James McAllister',    role: 'Partner, Meridian Legal',      text: 'As a law firm, we needed something polished but approachable. Veloce nailed it perfectly. Our inquiry rate has doubled since the new site went live.' },
  ...
  { initials: 'PW', name: 'Priya Watts',         role: 'Director, Pinnacle Properties', text: 'The turnaround blew my mind — 12 days from kickoff to launch. And it looked incredible. I\'ve already referred three clients. Veloce is the real deal.' },
